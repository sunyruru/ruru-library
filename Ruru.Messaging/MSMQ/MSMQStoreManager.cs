namespace Ruru.Messaging.MSMQ
{
    ...
    /// </summary>
    public class MSMQStoreManager : System.IDisposable, Ruru.Messaging.IStoreManager
    {
        ...
        /// Default Ctor.
        /// </summary>
        public MSMQStoreManager() { }

        /// <summary>
        /// MSMQ Path를 입력받아 인스턴스 생성
        /// </summary>
        /// <param name="sQueuePath">MSMQ 경로</param>
        public MSMQStoreManager(string sQueuePath) : this(sQueuePath, StoreManagerMode.Write) { }
